...
This implies that  every percent increase in Population Density (measured in people / square mile) causes a `r model1$coefficients[2] %>% format(digits=2)`% increase in Covid19 Cases per 100,000 people in a state. While it is likely not feasible to reduce Population Density, this relationship should inform policy makers as to which states to direct funding.

```{r covid-density-scatter, echo=FALSE, message=FALSE, warning=FALSE}
