...
From data source (3) we expect to get:
  - Covid-19 case counts by state

# Methodology and Expected outcome
We intend to use a linear model to investigate whether relationships between Covid-19 cases and the limiting measures taken by each state are related. We expect to either find or fail to find evidence that the measures have any relationship to Covid-19 cases. 